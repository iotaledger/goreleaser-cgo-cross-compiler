...
# GoReleaser
ENV GORELEASER_VERSION=0.140.0
ENV GORELEASER_SHA=1aed6f2414483180c52fe4a0a2a8c34da3e0d623eb9a536a5877054e29f69aab
ENV GORELEASER_DOWNLOAD_FILE=goreleaser_Linux_x86_64.tar.gz
ENV GORELEASER_DOWNLOAD_URL=https://github.com/goreleaser/goreleaser/releases/download/v${GORELEASER_VERSION}/${GORELEASER_DOWNLOAD_FILE}

# Golang
ENV GOLANG_VERSION=1.14.5
ENV GOLANG_SHA=82a1b84f16858db03231eb201f90cce2a991078dda543879b87e738e2586854b
